...
const LegalNotice = (): ReactElement => {
  return (
    <section className="w-screen md:min-h-dvh bg-blueWaves bg-center bg-auto md:bg-cover bg-repeat md:bg-no-repeat py-36 px-10 md:px-60">
      <h2 className="text-center text-3xl md:text-5xl text-white mb-14 uppercase">Mentions légales</h2>
      <div className="flex flex-col items-start justify-center gap-16">
        ...
        <div>
          <h4 className="text-2xl text-white mb-4">Propriété intellectuelle</h4>
          <p className="text-lg text-white" style={{ fontFamily: "Montserrat, sans-serif" }}>
        ...
        <div>
          <h4 className="text-2xl text-white mb-4">Marques</h4>
          <p className="text-lg text-white" style={{ fontFamily: "Montserrat, sans-serif" }}>
        ...
        <div>
          <h4 className="text-2xl text-white mb-4">Limitation de responsabilité</h4>
          <p className="text-lg text-white" style={{ fontFamily: "Montserrat, sans-serif" }}>
