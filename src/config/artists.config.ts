...
export const artists: Artist[] = [
  {
    name: "Lucien Dahais",
    imagePath: "/artistes/lucien-dahais.webp",
    bio: [
  ...
  },
  {
    ...
    imagePath: "/artistes/cutting-corners.webp",
    bio: [
  ...
  {
    name: "Alice April",
    imagePath: "/artistes/alice-april.webp",
    bio: [
  ...
  {
    name: "Boostee",
    imagePath: "/artistes/boostee.webp",
    bio: [
  ...
  {
    name: "Grayssoker",
    imagePath: "/artistes/grayssoker.webp",
    bio: [
      "Grayssoker innove sur la scène électro depuis quelques années. Accordéoniste hétéroclite, il est issu de la musique traditionnelle, a grandi avec le métal et joue aujourd’hui de la techno avec le génie Do It Yourself d’un punk.",
      "Il grandit dans le sud-est de la France au cœur de la culture des bals musette et dirige alors son attention vers l’instrument mythique du genre : l’accordéon. C’est lors du Nice Jazz Festival en 2017 que sa carrière musicale prend un premier tournant. Alors que les élèves du conservatoire de la ville sont invités à monter sur scène, Grayssoker apparait ce jour-là avec un accordéon à l’allure particulière.",
      "En 2018, quelques mois après cette première interprétation, le jeune artiste sortira son premier EP éponyme « Grayssoker », qui sera suivi en 2019 de « Fuck Musette », un 2nd EP remixé par le DJ Mike Rock. Cette même année, il apparaitra dans plusieurs médias nationaux où ses performances feront sensation auprès d’un large public et finira sur la scène du Hellfest.",
      "Attiré par la musique électronique, il se détourne progressivement du métal pour se consacrer à la création d’une musique mélangeant Électro, Dub et Trance, habillée de solo d’accordéons enivrants et hypnotiques.",
  ...
  {
    name: "Plage Arrière",
    imagePath: "/artistes/plage-arriere.webp",
    bio: [
      "Plage arrière c’est des chansons et une furieuse envie de faire la fête. Une bande de copains qui se fait plaisir et qui invite tout le monde à en faire autant. Un grand moment de partage et de la joie dans les oreilles. 🌐",
  ...
  {
    name: "Michel Mercury",
    imagePath: "/artistes/michel-mercury.webp",
    bio: [
